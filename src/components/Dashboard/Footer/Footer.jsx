...
const Footer = () => {
  ...
  const text1 = "This is a blue Ocean Project, Made by the team PROJECT HIRE HUNT - PATRICK, JOEY, SEAN, BEN, PEDRO"
    ...
    <>
      <div className="footer">
        <ul className="footer-links">
          <li><a href="#" onClick={(e) => handleLinkClick(e, text1)}>About us</a></li>
          <li><a href="#" onClick={(e) => handleLinkClick(e,text2)}>Contact us</a></li>
          <li><a href="#" onClick={(e) => handleLinkClick(e, text3)}>Terms of Service</a></li>
        </ul>
      </div>
      <Modal
