		...
		return (
			<div className={styles.settingDropdown}>
				...
				<div className={styles.settingDropdownList}>
					<a
						onClick={(e) => handleLinkClick(e, "changeEmail")}
						className={styles.settingDropdownItem}
					>
						Change Email
					</a>
					<a
						onClick={(e) => handleLinkClick(e, "addAdmin")}
						className={styles.settingDropdownItem}
					>
						Add Admin
					</a>
					<a
						onClick={(e) => handleLinkClick(e, "deleteAdmin")}
						className={styles.settingDropdownItem}
					>
						Remove Admin
					</a>
					<a
						onClick={(e) => handleLinkClick(e, "addCohort")}
						className={styles.settingDropdownItem}
					>
						Add Cohort
					</a>
					<a
						onClick={(e) => handleLinkClick(e, "assignCohort")}
						className={styles.settingDropdownItem}
					>
						assign a student
					</a>
					...
					<a
						onClick={(e) => handleLinkClick(e, "assignAssignment")}
						className={styles.settingDropdownItem}
					>
	...
	return (
		<div className={styles.settingDropdown}>
			...
			<div className={styles.settingDropdownList}>
				...
				<a
					onClick={(e) => handleLinkClick(e, "changeLocation")}
					className={styles.settingDropdownItem}
				>
					Change Location
				</a>
				<a
					onClick={(e) => handleLinkClick(e, "changeDesiredLocation")}
					className={styles.settingDropdownItem}
				>
