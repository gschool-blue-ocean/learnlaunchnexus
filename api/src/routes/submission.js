...
router.patch('/:id', async (req, res) => {
    ...
    try {
        ...
        console.error(err.message);
        res.status(500).send('Internal Servor Err' + err.message);
    }
});
